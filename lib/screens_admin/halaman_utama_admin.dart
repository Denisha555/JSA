...
//                 bookingData[time]![court]!['username'] = nameController.text;
//               });
...
//     final courts = ['Lapangan 1', 'Lapangan 2', 'Lapangan 3', 'Lapangan 4', 'Lapangan 5', 'Lapangan 6'];
...
//                   ScaffoldMessenger.of(context).showSnackBar(
//                     SnackBar(content: Text('Please select both time slot and court')),
//                   );
//                   return;
//                 }
...
//                 if (bookingData[selectedTimeSlot]![selectedCourt]!['status'] == 'booked') {
//                   ScaffoldMessenger.of(context).showSnackBar(
//                     SnackBar(content: Text('This time slot is already booked')),
//                   );
//                 } else {
//                   _showAddBookingDialog(selectedTimeSlot!, selectedCourt!);
//                 }
//               },
//               child: Text('Next'),
//             ),
...
//   Widget _buildCourtCell(String time, String court, bool isBooked, String username) {
//     return InkWell(
//       onTap: () {
//         if (isBooked) {
